...
#' @export
#' @import data.table 
krasddpcams__plot_ddG_all_allosteric_heatmap<-function(
  ddG1=ddG1,
  assay1=assay1,
  ddG2=ddG2,
  assay2=assay2,
  ...
  ggplot2::ggplot()+
    ...
    ggplot2::theme(text = ggplot2::element_text(size=7),
          ...
          axis.text.y = ggplot2::element_text(family="Courier",size=5, vjust = .5,hjust = -10,margin=ggplot2::margin(0,0,0,0)),
