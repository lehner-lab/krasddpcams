...
#' @return Nothing
#' @export
Plot_ddG_fullRAF_RBD<-function(ddG1=ddG1,
                               ddG2=ddG2,
                               ci95_1=ci95_1,
                               ci95_2=ci95_2){
  # merge data
  ...
  #              aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),color="black",alpha=0.6,size=0.1)+
  #   geom_point(data=all_ddG_dc[bind=="CRD"&`std_kcal/mol_a`<0.1&`std_kcal/mol_b`<0.1,],
  #              aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),color=colour_scheme[["yellow"]],alpha=0.6,size=0.1)+
  #   geom_point(data=all_ddG_dc[bind=="RBD+CRD"&`std_kcal/mol_a`<0.1&`std_kcal/mol_b`<0.1,],
  #              aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),color=colour_scheme[["red"]],alpha=0.6,size=0.1)+
  #   geom_smooth(data=all_ddG_dc[`std_kcal/mol_a`<0.1&`std_kcal/mol_b`<0.1,],aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),
  ...
  #plot
  ggplot()+
    geom_point(data=all_ddG_dc[bind=="others"&`ci95_kcal/mol_a`<ci95_1&`ci95_kcal/mol_b`<ci95_2,],
               aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),color="black",alpha=0.6,size=2)+
    geom_point(data=all_ddG_dc[bind=="CRD"&`ci95_kcal/mol_a`<ci95_1&`ci95_kcal/mol_b`<ci95_2,],
               aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),color=colour_scheme[["yellow"]],alpha=0.6,size=2)+
    geom_point(data=all_ddG_dc[bind=="RBD+CRD"&`ci95_kcal/mol_a`<ci95_1&`ci95_kcal/mol_b`<ci95_2,],
               aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),color=colour_scheme[["red"]],alpha=0.6,size=2)+
    geom_smooth(data=all_ddG_dc[`ci95_kcal/mol_a`<ci95_1&`ci95_kcal/mol_b`<ci95_2,],aes(x=`mean_kcal/mol_a`,y=`mean_kcal/mol_b`),
                method=lm, se=T,size=0.1,color=colour_scheme[["red"]])+
    annotate("text",x=-0.5,y=2.00,label = paste0("r = ",round(sqrt(summary(bind_lm_ddG)$r.squared),2)) ,size=7*0.35)+
    theme_classic2()+
    labs(color=NULL)+
