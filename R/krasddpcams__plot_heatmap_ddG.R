...
#' @export
#' @import data.table 
krasddpcams__plot_heatmap_ddG<-function(
  input=input,
  assay_name=assay_name,
  wt_aa,
  colour_scheme
  ){
  input<-krasddpcams__read_ddG(ddG = input,assay_sele = assay_name)
  ...
  ggplot2::ggplot()+
    ...
    ggplot2::theme(text = ggplot2::element_text(size=5),
          ...
          axis.text.y = ggplot2::element_text(family="Courier",angle=90,size=5, vjust = .5,hjust = .5,margin=ggplot2::margin(0,-0.5,0,0,"mm")),
