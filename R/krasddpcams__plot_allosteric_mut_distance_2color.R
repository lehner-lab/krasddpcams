...
#' @export
#' @import data.table 
krasddpcams__plot_allosteric_mut_distance_2color<-function(
  ...
  ggplot2::ggplot(data_plot_mutation,ggplot2::aes(x=scHAmin_ligand_RAF,y=`mean_kcal/mol`))+
    ggplot2::geom_smooth(data=data_plot_mutation[colors_type2=="others",],method=lm,se=T,color="black")+
    ggplot2::geom_smooth(data=data_plot_mutation[colors_type2=="beta sheet"|colors_type2=="GTP+beta sheet",],method=lm,se=T,color=colour_scheme[["red"]])+
    ggplot2::geom_smooth(data=data_plot_mutation[colors_type2=="GTP"|colors_type2=="GTP+beta sheet",],method=lm,se=T,color=colour_scheme[["blue"]])+
    ggplot2::geom_point(ggplot2::aes(color=colors_type2),size=1*0.35)+
    ggplot2::geom_vline(xintercept = 5,linetype =2)+
    ggplot2::scale_color_manual(values = c(colour_scheme[["red"]],colour_scheme[["blue"]],colour_scheme[["purple"]],"black"))+
