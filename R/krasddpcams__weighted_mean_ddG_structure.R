...
#' @export 
#' @import data.table
krasddpcams__weighted_mean_ddG_structure<-function(
  ddG=ddG,
  input_PDB=input_PDB,
  ...
  weighted_mean_ddG_sel<-krasddpcams__get_weighted_mean_ddG(ddG=ddG,
                                               assay_sele = "sele")
  input_structure<-bio3d::read.pdb(input_PDB)
  ...
  bio3d::write.pdb(output_PDB,file=output_PDB_file)
}
