...
#' @export
doubledeepms__abundance_predict_fitness<-function(mochi_parameters=mochi_parameters,
                                                  fold_n=fold_n,
                                                  folding_energy=folding_energy,
                                                  RT=0.001987*(273+30)){
  mochi_model<-fread(mochi_parameters)
  folding_fraction<-doubledeepms__fraction_folded(folding_energy = folding_energy,RT=RT)
