...
#' @export
doubledeepms__bind_predict_fitness<-function(mochi_parameters=mochi_parameters,
                                             folding_energy=folding_energy,
                                             binding_energy=binding_energy,
                                             RT=0.001987*(273+30)){
  mochi_model<-fread(mochi_parameters)
  fraction_bound<-doubledeepms__fraction_bound(folding_energy = folding_energy,binding_energy = binding_energy)
