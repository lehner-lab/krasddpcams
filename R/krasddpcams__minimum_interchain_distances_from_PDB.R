...
#' minimum interchain distance Function
#' 
#' This function allows you to calculate minimum interchain distance from PDB files.
#' @param input_file PDB file
#' @param chain_query KRAS chain
#' @param chain_target binding interactor chain
#' @return result_dt
#' @export
#' @import data.table
krasddpcams__minimum_interchain_distances_from_PDB <- function(
  input_file,
  chain_query = "A",
  chain_target = "B"
  ){
