...
#' @return Nothing
#' @export
Plot3d_ddGf_ddGb_ob_pre_fitness<-function(binding_input=binding_input,
  ...
  energy_grid_dt
  fitness_binding<-doubledeepms__bind_predict_fitness(mochi_parameters=mochi_parameters,
  ...
  persp3D(x=binding_energy_grid1*RT,
  ...
  scatter3D(x=ddg_merge1[,fold_1_additive_trait1*RT],
