...
#' @return Nothing
#' @export
Plot_fitness_cor_RAF1_full_RBD_color_fig3<-function(fitness1=fitness1,
                                         fitness2=fitness2,
  ...
  ggplot(data=mix_anno,aes(nor_fitness.x,nor_fitness.y,color=mutation_type))+
    geom_point(size=0.1)+
    annotate("text",x=-1,y=0,,label = paste0("r = ",round(sqrt(summary(r_model)$r.squared),2)) ,size=7*0.35)+
